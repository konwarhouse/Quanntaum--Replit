...
const SimulationForm = () => {
  ...
  const [usePM, setUsePM] = useState(false);
        ...
        <CardContent>
          {simulationMutation.isPending ? (
            ...
            <div className="space-y-6">
              ...
              <div className="p-4 bg-muted rounded-md">
                ...
                <ul className="space-y-2 text-sm">
                  ...
                  {usePM && (
                    <li><span className="font-semibold">PM Cost:</span> ${formData.pmCost}</li>
                  )}
                </ul>
              </div>
              ...
              <div className="border p-4 rounded-md">
                ...
                <ul className="space-y-2 text-sm">
                  <li className="flex items-start">
                    ...
                    <span>
                      <strong>Histogram:</strong> Shows the distribution of failure times across the simulation runs. Clustering indicates typical failure patterns.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-primary">•</span>
                    <span>
                      <strong>Average Failures:</strong> The expected number of failures within the time horizon.
                    </span>
                  </li>
                  <li className="flex items-start">
                    <span className="mr-2 text-primary">•</span>
                    <span>
                      <strong>Total Cost:</strong> The expected maintenance cost (preventive + corrective) within the time horizon.
                    </span>
                  </li>
                  {formData.beta > 1 && usePM && (
                    <li className="flex items-start">
                      <span className="mr-2 text-primary">•</span>
                      <span>
                        With β {`>`} 1 (wear-out region), preventive maintenance typically reduces overall cost.
                      </span>
                    </li>
                  )}
                  {formData.beta <= 1 && usePM && (
                    <li className="flex items-start">
                      <span className="mr-2 text-primary">•</span>
                      <span>
                        With β ≤ 1 (infant mortality or constant failure rate), run-to-failure may be more cost-effective.
                      </span>
                    </li>
                  )}
                </ul>
            ...
            <div className="flex flex-col items-center justify-center h-96 text-muted-foreground">
              <p>Enter simulation parameters and click "Run Simulation" to see results</p>
            </div>
          )}
        </CardContent>
      </Card>
