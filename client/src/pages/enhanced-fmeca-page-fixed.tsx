                        ...
                        <tr key={row.id}>
                          ...
                          <td className="border border-gray-300 p-2 text-center">
                            <div className="flex space-x-2 justify-center">
                              ...
                              <FmecaHistoryButton recordId={parseInt(row.id)} recordType="asset" variant="outline" iconOnly={true} />
                              <Button 
                                variant="destructive" 
                                size="sm"
                        ...
                        <tr key={row.id}>
                          ...
                          <td className="border border-gray-300 p-2 text-center">
                            <div className="flex space-x-2 justify-center">
                              ...
                              >
                                <Pencil className="h-4 w-4" />
                              <FmecaHistoryButton recordId={parseInt(row.id)} recordType="system" variant="outline" iconOnly={true} />
                              </Button>
                              <Button 
                                variant="destructive" 
                                size="sm"
